...
variable "vm_size" {
  description = "Tamaño (SKU) de la máquina virtual Azure. Por defecto: Standard_B2ats_v2."
  type        = string
  default     = "Standard_B2ats_v2"

  validation {
    condition     = can(regex("^Standard_", var.vm_size))
    error_message = "El tamaño de VM debe ser un SKU válido de Azure que comience con 'Standard_' (ej: Standard_B2ats_v2, Standard_D2s_v3)."
  }
}
